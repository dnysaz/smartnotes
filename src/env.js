...
export const env = {
    ...
    // Google Drive API Key (Renamed to bypass Vercel security filters)
    GOOGLE_API_KEY: import.meta.env.VITE_APP_G_KEY || '',
...
export function checkEnv() {
    const required = ['VITE_GOOGLE_CLIENT_ID', 'VITE_APP_G_KEY'];
    let missing = [];
